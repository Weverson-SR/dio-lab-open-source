...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Weverson-SR/dio-lab-open-source.git é o "**fork**" feito pelo usuário do GitHub "`Weverson-SR`" para a contribuição no repositório `dio-lab-open-source`.
